...
draw_text(_gold_text_x,_gold_text_y,string_hash_to_newline(Get_Menu_Display_Message("Generic","Gold")));
draw_set_halign(fa_right);
draw_text(_gold_ammount_x,_gold_ammount_y,string_hash_to_newline(string(global.Gold)));
draw_set_halign(fa_left);
