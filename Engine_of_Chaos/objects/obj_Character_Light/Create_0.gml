...
x_offset = 12;//draw location x offset
y_offset = 12;//draw location y offset
alpha = 1;//alpha of the light
target = id;//object the light source is following

//default light
outer_light_color = c_black;//outer light color
inner_light_color = c_white;//inner light color
radius = 45;//radius of the light
