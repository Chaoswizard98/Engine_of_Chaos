//Draw_Name_Character_Menu();

//===============
//Draw Locations=
//===============
var _window_x = Get_Anchor_X("Top_Left") + name_character_window_x;
var _window_y = Get_Anchor_Y("Top_Left") + name_character_window_y + floor(name_character_window_pan);
...
var _name_window_x = Get_Anchor_X("Top_Left") + character_name_window_x + floor(character_name_window_pan_x);
var _name_window_y = Get_Anchor_Y("Top_Left") + character_name_window_y - floor(character_name_window_pan_y);
