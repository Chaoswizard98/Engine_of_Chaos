...
var _text_x = _window_x + 10;
var _text_y = _window_y + 10;

var _arrow_x = _text_x + 105;
var _arrow_y = _text_y;
...
draw_sprite(spr_Start_Menu_Window,0,_window_x, _window_y);//Draw the window
draw_sprite(spr_Menu_Arrow_Left,0,_arrow_x, _arrow_y + (arrow_position * _text_increment));//Draw the selection arrow
