function Level_Scheme_SF2_Wolfman_Gerhalt(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 9; _projected = 41; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early+Late"); break;
	    case "Max_Magic": _base = 0; _projected = 0; _gain = 0; break;
	    case "Attack": _base = 14; _projected = 58; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    case "Defense": _base = 7; _projected = 41; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 7; _projected = 39; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Class_Name": _base = "Wolfman"; break;
	    case "Class_Abbreviation": _base = "WFMN"; break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Wolf_Baron_Gerhalt"; break;
