function Level_Scheme_SF2_Ninja_Slade(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 28; _projected = 90; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    case "Max_Magic": _base = 0; _projected = 50; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Attack": _base = 29; _projected = 53; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    case "Defense": _base = 25; _projected = 82; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    case "Agility": _base = 25; _projected = 72; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    ...
	    case "Class_Name": _base = "Ninja"; break;
	    case "Class_Abbreviation": _base = "NINJ"; break;
	    case "Movement_Range": _base = 6; break;
	    case "Movement_Type": _base = "Fast"; break;
