function Set_Character_Status_Magic_Immunity(_lookup_type,_character,_formula,_ammount,_stat) {
	var _base, _index;
	...
	if(_lookup_type = "Global"){
	    _base = global.Magic_Immunity[_character,_index];
	}
	else if(_lookup_type = "Local"){
	    _base = _character.magic_immunity[_index];
	}
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Magic_Immunity[_character,_index] = _base;
	}
	else if(_lookup_type = "Local"){
	    _character.magic_immunity[_index] = _base;
	}
