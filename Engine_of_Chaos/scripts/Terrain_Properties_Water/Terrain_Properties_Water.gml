function Get_Terrain_Stats_Water(_movement_type,_stat){
	//=============
	//Default Stats
	//=============
	var _sprite = spr_Terrain_Water;
	var _background_sprite = spr_Battle_Background_Default;
	var _foreground_sprite = spr_Battle_Foreground_Water;
	...
	switch(_movement_type){
	    ...
	    case "Aquatic": _movement_cost = 1; _land_effect = .30; break;
	    case "Amphibious": _movement_cost = 1; _land_effect = .30; break;
	}
