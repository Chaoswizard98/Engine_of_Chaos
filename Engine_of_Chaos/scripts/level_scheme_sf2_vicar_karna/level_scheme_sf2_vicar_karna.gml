function Level_Scheme_SF2_Vicar_Karna(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	switch(_stat){
	    ...
	    case "Max_Magic": _base = 38; _projected = 91; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Middle"); break;
	    case "Attack": _base = 19; _projected = 23; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Middle"); break;
	    case "Defense": _base = 20; _projected = 45; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early+Late"); break;
