function Town_Character_Stats_Enemy_Wolf(_character){
	with(_character){
		name = "Wolf";//Name
...
//======================
function Get_Appearance_Enemy_Wolf(_lookup_type,_character,_stat){
...
//Battle Sprite Setup
//===================
function Get_Battle_Sprite_Stats_Enemy_Wolf(_animation,_stat){
	//=============
