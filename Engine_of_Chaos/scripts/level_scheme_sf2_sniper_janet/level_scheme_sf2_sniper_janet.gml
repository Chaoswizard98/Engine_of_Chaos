function Level_Scheme_SF2_Sniper_Janet(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
		case "Max_Health": _base = 31; _projected = 81; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Max_Magic": _base = 0; _projected = 0; break;
	    case "Attack": _base = 20; _projected = 32; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 21; _projected = 62; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 24; _projected = 65; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Class_Name": _base = "Sniper"; break;
	    case "Class_Abbreviation": _base = "SNIP"; break;
