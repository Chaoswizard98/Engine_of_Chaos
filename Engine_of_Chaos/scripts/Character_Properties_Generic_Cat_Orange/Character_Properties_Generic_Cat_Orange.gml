function Town_Character_Stats_Generic_Cat_Orange(_character){
	with(_character){
...
//======================
function Get_Appearance_Generic_Cat_Orange(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Generic_Cat_Orange_Overworld;
	var _portrait = noone;
