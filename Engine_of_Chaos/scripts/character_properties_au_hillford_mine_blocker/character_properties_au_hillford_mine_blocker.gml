function Town_Character_Stats_AU_Hillford_Mine_Blocker(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "AU_Hillford_Mine_Blocker";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_AU_Hillford_Mine_Blocker(_lookup_type,_character,_stat){
