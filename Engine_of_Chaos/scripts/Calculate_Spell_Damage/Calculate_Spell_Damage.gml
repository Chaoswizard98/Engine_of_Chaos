function Calculate_Spell_Damage() {
	...
	//Get Damages
	var _fire_damage = floor(((Get_Effect_Stats(_effect,_level,"Fire_Damage","Local",_attacker) / _divisor) * _fire_resistance) * _magic_resistance);
	var _ice_damage = floor(((Get_Effect_Stats(_effect,_level,"Ice_Damage","Local",_attacker) / _divisor) * _ice_resistance) * _magic_resistance);
	var _water_damage = floor(((Get_Effect_Stats(_effect,_level,"Water_Damage","Local",_attacker) / _divisor) * _water_resistance) * _magic_resistance);
	var _lightning_damage = floor(((Get_Effect_Stats(_effect,_level,"Lightning_Damage","Local",_attacker) / _divisor) * _lightning_resistance) * _magic_resistance);
	var _wind_damage = floor(((Get_Effect_Stats(_effect,_level,"Wind_Damage","Local",_attacker) / _divisor) * _wind_resistance) * _magic_resistance);
	var _earth_damage = floor(((Get_Effect_Stats(_effect,_level,"Earth_Damage","Local",_attacker) / _divisor) * _earth_resistance) * _magic_resistance);
	var _light_damage = floor(((Get_Effect_Stats(_effect,_level,"Light_Damage","Local",_attacker) / _divisor) * _light_resistance) * _magic_resistance);
	var _shadow_damage = floor(((Get_Effect_Stats(_effect,_level,"Shadow_Damage","Local",_attacker) / _divisor) * _shadow_resistance) * _magic_resistance);

	var _magic_damage = floor((Get_Effect_Stats(_effect,_level,"Magic_Damage","Local",_attacker) / _divisor) * _magic_resistance);
	var _void_damage = floor(Get_Effect_Stats(_effect,_level,"Void_Damage","Local",_attacker) / _divisor);
	var _heal_ammount = floor(Get_Effect_Stats(_effect,_level,"Heal_Ammount","Local",_attacker) / _divisor);
