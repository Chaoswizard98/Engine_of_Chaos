function Town_Character_Stats_Generic_Chicken(_character){
	with(_character){
...
//======================
function Get_Appearance_Generic_Chicken(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Generic_Chicken_Overworld;
	var _portrait = noone;
	var _voice = Get_Generic_Voice("Generic_Chicken");
