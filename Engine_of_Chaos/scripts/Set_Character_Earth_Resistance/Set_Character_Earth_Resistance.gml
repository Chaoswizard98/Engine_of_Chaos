function Set_Character_Earth_Resistance(_lookup_type,_character,_formula,_ammount) {
	var _base;
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Earth_Resistance[_character] = max(_base,1);
	}
	else if(_lookup_type = "Local"){
	    _character.earth_resistance = max(_base,1);
	}
