function Set_Character_Status_Defense_Down(_lookup_type,_character,_formula,_ammount,_stat) {
	var _base, _index;
	...
	if(_lookup_type = "Global"){
	    _base = global.Defense_Down[_character,_index];
	}
	else if(_lookup_type = "Local"){
	    _base = _character.defense_down[_index];
	}
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Defense_Down[_character,_index] = _base;
	}
	else if(_lookup_type = "Local"){
	    _character.defense_down[_index] = _base;
	}
