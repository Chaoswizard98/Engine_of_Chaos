function Set_Character_Shadow_Damage(_lookup_type,_character,_formula,_ammount) {
	var _base;
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Shadow_Damage[_character] = max(_base,1);
	}
	else if(_lookup_type = "Local"){
	    _character.shadow_damage = max(_base,1);
	}
