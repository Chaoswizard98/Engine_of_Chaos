function Level_Scheme_SF2_Gladiator_Randolf(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	switch(_stat){
	    ...
	    case "Defense": _base = 33; _projected = 104; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 21; _projected = 52; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    ...
	    case "Class_Name": _base = "Gladiator"; break;
	    case "Class_Abbreviation": _base = "GLDT"; break;
