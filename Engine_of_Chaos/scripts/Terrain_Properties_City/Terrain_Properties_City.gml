function Get_Terrain_Stats_City(_movement_type,_stat){
	//=============
	//Default Stats
	//=============
	var _sprite = spr_Terrain_City;
	var _background_sprite = spr_Battle_Background_City;
	...
	switch(_movement_type){
	    ...
	    case "Foot": _movement_cost = 1; _land_effect = .5; break;
	    case "Horse": _movement_cost = 1; _land_effect = .5; break;
	    case "Fast": _movement_cost = 1; _land_effect = .5; break;
	    case "Tires": _movement_cost = 1; _land_effect = .5; break;
	    case "Flying": _movement_cost = 1; _land_effect = 0; break;
	    case "Hover": _movement_cost = 1; _land_effect = .5; break;
