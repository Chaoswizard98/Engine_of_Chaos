function Level_Scheme_SF2_Knight_Rick(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 10; _projected = 46; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    case "Max_Magic": _base = 0; _projected = 0; _gain = 0; break;
	    case "Attack": _base = 6; _projected = 32; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Middle"); break;
	    case "Defense": _base = 7; _projected = 39; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Middle"); break;
	    case "Agility": _base = 7; _projected = 39; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Paladin_Rick"; break;
	    case "Promotion_2": _base = "SF2_Pegasus_Knight_Rick"; break;
