function Set_Character_Status_Movement_Up(_lookup_type,_character,_formula,_ammount,_stat) {
	var _base, _index;
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Movement_Up[_character,_index] = _base;
	}
	else if(_lookup_type = "Local"){
	    _character.movement_up[_index] = _base;
	}
