function Level_Scheme_Archer_1(_lookup_type,_character,_stat,_sub_stat){
	...
	switch(_stat){
	    ...
	    case "Defense": _base = 4; _early_gain = .8; _mid_gain = .8; _late_gain = .8; break;
	    case "Agility": _base = 6; _early_gain = .8; _mid_gain = .8; _late_gain = .8; break;
	    case "Max_Health": _base = 12; _early_gain = .9; _mid_gain = .9; _late_gain = .9; break;
