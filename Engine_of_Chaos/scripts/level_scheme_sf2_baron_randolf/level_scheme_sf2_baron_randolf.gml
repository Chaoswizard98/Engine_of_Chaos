function Level_Scheme_SF2_Baron_Randolf(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
		case "Max_Health": _base = 33; _projected = 89; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Max_Magic": _base = 0; _projected = 0; break;
	    case "Attack": _base = 30; _projected = 53; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 33; _projected = 94; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 21; _projected = 57; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    ...
	    case "Class_Name": _base = "Baron"; break;
	    case "Class_Abbreviation": _base = "BRN"; break;
	    ...
	    case "Meets_Requirements": _base = ((_character_level >= 20) && Has_Item_In_Inventory(_lookup_type,_character,"SF2_Warrior_Pride")) break;
	    case "Promotion_Event": 
			Remove_Item(_lookup_type,_character,Get_Item_Slot(_lookup_type,_character,"SF2_Warrior_Pride")); 
			Set_Character_Movement_Range(_lookup_type,_character,"Add",1);
		break;//Put whatever script you want in here. (Such as removing an item upon promotion)
	}
