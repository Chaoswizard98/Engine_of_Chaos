function Level_Scheme_SF2_Knight_Chester(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 11; _projected = 59; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    case "Max_Magic": _base = 0; _projected = 0; _gain = 0; break;
	    case "Attack": _base = 5; _projected = 35; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 5; _projected = 35; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early+Late"); break;
	    case "Agility": _base = 7; _projected = 35; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Class_Name": _base = "Knight"; break;
	    case "Class_Abbreviation": _base = "KNT"; break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Paladin_Chester"; break;
	    case "Promotion_2": _base = "SF2_Pegasus_Knight_Chester"; break;
