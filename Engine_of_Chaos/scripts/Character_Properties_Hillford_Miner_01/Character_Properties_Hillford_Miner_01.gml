function Town_Character_Stats_Hillford_Miner_01(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "Hillford_Miner_01";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_Hillford_Miner_01(_lookup_type,_character,_stat){
