function Set_Character_Light_Resistance(_lookup_type,_character,_formula,_ammount) {
	var _base;
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Light_Resistance[_character] = max(_base,1);
	}
	else if(_lookup_type = "Local"){
	    _character.light_resistance = max(_base,1);
	}
