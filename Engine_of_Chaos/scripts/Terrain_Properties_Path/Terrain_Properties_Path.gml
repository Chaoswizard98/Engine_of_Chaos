function Get_Terrain_Stats_Path(_movement_type,_stat){
	//=============
	//Default Stats
	//=============
	...
	switch(_movement_type){
	    ...
	    case "Foot": _movement_cost = 1; _land_effect = 0; break;
	    case "Horse": _movement_cost = 1; _land_effect = 0; break;
	    case "Fast": _movement_cost = 1; _land_effect = 0; break;
	    case "Tires": _movement_cost = 1; _land_effect = 0; break;
	    case "Flying": _movement_cost = 1; _land_effect = 0; break;
	    case "Hover": _movement_cost = 1; _land_effect = 0; break;
	    case "Aquatic": _movement_cost = 0; _land_effect = 0; break;
	    case "Amphibious": _movement_cost = 1; _land_effect = 0; break;
	}
