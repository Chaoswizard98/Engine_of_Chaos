function Level_Scheme_SF2_Pegasus_Knight_Chester(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
		case "Max_Health": _base = 34; _projected = 90; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early+Late"); break;
	    case "Max_Magic": _base = 0; _projected = 0; break;
	    case "Attack": _base = 24; _projected = 47; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 21; _projected = 66; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 22; _projected = 63; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Class_Name": _base = "Pegasus Knight"; break;
	    case "Class_Abbreviation": _base = "PGNT"; break;
	    case "Movement_Range": _base = 7; break;
	    case "Movement_Type": _base = "Horse"; break;
	    ...
	    case "Meets_Requirements": _base = ((_character_level >= 20) && Has_Item_In_Inventory(_lookup_type,_character,"SF2_Pegasus_Wing")) break;
	    case "Promotion_Event": Remove_Item(_lookup_type,_character,Get_Item_Slot(_lookup_type,_character,"SF2_Pegasus_Wing")); break;//Put whatever script you want in here. (Such as removing an item upon promotion)
	}
