function Level_Scheme_SF2_Mage_Kazin(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 10; _projected = 34; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Max_Magic": _base = 7; _projected = 54; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    case "Attack": _base = 4; _projected = 18; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 4; _projected = 26; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 6; _projected = 42; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Spell_2": 
			_base = "SF2_Muddle";
		switch(Get_Character_Level(_lookup_type,_character,"Total")){
				case 9: _level = 1; break;
				case 25: _level = 2; break;
			}
		break;
	    ...
	    case "Spell_4": 
			_base = "SF2_Desoul"; 
		switch(Get_Character_Level(_lookup_type,_character,"Total")){
				case 18: _level = 1; break;
				case 29: _level = 2; break;
			}
		break;
    
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Wizard_Kazin"; break;
	    case "Promotion_2": _base = "SF2_Sorcerer_Kazin"; break;
