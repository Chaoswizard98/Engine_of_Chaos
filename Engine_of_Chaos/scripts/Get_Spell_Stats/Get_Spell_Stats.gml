function Get_Spell_Stats(_effect,_effect_level,_return_stat,_lookup_type = "none",_character = noone){
	...
	if(instance_exists(obj_Spell_Variable_Utility)){//if the temporary container already exists, 
		...
		Spell_Stats_Default(_container);//reset stats
	}
	...
	//Run Stat Script=
	//================
	var _script = asset_get_index("Spell_Stats_"+_effect);
