function Level_Scheme_Swordsman_1(_lookup_type,_character,_stat,_sub_stat){
	...
	//=================
	switch(_stat){
	    case "Attack": _base = 8; _early_gain = 1.1; _mid_gain = 1.1; _late_gain = 1.1; break;
	    case "Defense": _base = 5; _early_gain = .9; _mid_gain = .9; _late_gain = .9; break;
	    case "Agility": _base = 4; _early_gain = .7; _mid_gain = .7; _late_gain = .7; break;
	    case "Max_Health": _base = 12; _early_gain = 1.1; _mid_gain = 1.1; _late_gain = 1.1; break;
	    case "Max_Magic": _base = 8; _early_gain = .5; _mid_gain = .5; _late_gain = .5; break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "Hero_1"; break;
