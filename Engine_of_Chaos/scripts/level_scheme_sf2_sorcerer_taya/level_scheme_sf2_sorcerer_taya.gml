function Level_Scheme_SF2_Sorcerer_Taya(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 24; _projected = 72; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Max_Magic": _base = 42; _projected = 85; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Attack": _base = 14; _projected = 26; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 17; _projected = 53; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 26; _projected = 68; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Spell_2": 
			_base = "SF2_Apollo";
		switch(Get_Character_Level(_lookup_type,_character,"Total")){
				case 32: _level = 1; break;
				case 39: _level = 2; break;
			}
		break;
	    ...
	    case "Spell_3": 
			_base = "SF2_Neptune"; 
		switch(Get_Character_Level(_lookup_type,_character,"Total")){
				case 42: _level = 1; break;
				case 49: _level = 2; break;
			}
		break;
	    ...
	    case "Spell_4": 
			_base = "SF2_Atlas"; 
		switch(Get_Character_Level(_lookup_type,_character,"Total")){
				case 45: _level = 1; break;
				case 54: _level = 2; break;
			}
		break;
