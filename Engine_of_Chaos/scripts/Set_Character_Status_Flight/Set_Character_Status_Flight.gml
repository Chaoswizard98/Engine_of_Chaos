function Set_Character_Status_Flight(_lookup_type,_character,_formula,_ammount,_stat) {
	var _base, _index;
	...
	if(_lookup_type = "Global"){
	    _base = global.Flight[_character,_index];
	}
	else if(_lookup_type = "Local"){
	    _base = _character.flight[_index];
	}
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Flight[_character,_index] = _base;
	}
	else if(_lookup_type = "Local"){
	    _character.flight[_index] = _base;
	}
