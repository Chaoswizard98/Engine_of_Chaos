function Town_Character_Stats_Cieras_Older_Brother(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "Cieras_Older_Brother";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_Cieras_Older_Brother(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Cieras_Older_Brother_Overworld; 
	var _portrait = noone;
