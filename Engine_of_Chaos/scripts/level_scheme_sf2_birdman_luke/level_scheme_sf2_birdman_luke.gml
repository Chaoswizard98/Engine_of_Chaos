function Level_Scheme_SF2_Birdman_Luke(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 12; _projected = 48; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Defense": _base = 6; _projected = 30; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 7; _projected = 41; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Class_Name": _base = "Birdman"; break;
	    case "Class_Abbreviation": _base = "BDMN"; break;
	    case "Movement_Range": _base = 6; break;
	    case "Movement_Type": _base = "Flying"; break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Bird_Battler_Luke"; break;
