function Shop_Repair_Event() {
	switch (state){
	    ...
	    case "Start":
	        ...
	        Create_Dialogue(noone,Get_Character_Voice("Local",current_npc,"Total"),Get_General_Messages(dialogue_ID,"Start_Repair"),id,true,true);//portrait, voice, message, current object, arrow, auto pan, [portrait override] [voice override]
	    break;
	    //===================
	    //Backed Out Of Menu=
	    //===================
