function Level_Scheme_SF2_Phoenik_Peter(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	switch(_stat){
	    ...
	    case "Attack": _base = 10; _projected = 70; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 8; _projected = 39; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 4; _projected = 30; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    ...
	    case "Class_Name": _base = "Phoenik"; break;
	    case "Class_Abbreviation": _base = "PHNK"; break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Phoenix_Peter"; break;
