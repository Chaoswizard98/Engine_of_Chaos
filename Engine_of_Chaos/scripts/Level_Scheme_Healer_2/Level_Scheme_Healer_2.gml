function Level_Scheme_Healer_2() {
	...
	switch(Get_Character_Level(_lookup_type,_character,"Total")){
	    case 4: _increment_spell_level = Increment_Spell_Level(_lookup_type,_character,"Heal",2); break;
	    case 5: _new_spell = "Detox"; break;
	    ...
	    case 29: _increment_spell_level = Increment_Spell_Level(_lookup_type,_character,"Detox",3); break;
	    case 33: _new_spell = "Aura"; break;
