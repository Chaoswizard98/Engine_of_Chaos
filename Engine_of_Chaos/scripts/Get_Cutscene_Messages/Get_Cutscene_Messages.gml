function Get_Cutscene_Messages(_cutscene_object,_message_ID){
	var _script = asset_get_index("Cutscene_Messages_"+global.Default_Language);
	var _new_script = asset_get_index("Cutscene_Messages_"+global.Language);
