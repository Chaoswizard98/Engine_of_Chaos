function Town_Character_Stats_Cow(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "Cow";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_Cow(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Cow_Overworld;
	var _portrait = noone;
	var _voice = Get_Generic_Voice("Cow");
