...
//======================
function Town_Character_Stats_Jason(_character){
	with(_character){
...
//======================
function Get_Appearance_Jason(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Jason_Overworld; 
	var _portrait = spr_Jason_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Jason_SDMN";
...
//Battle Sprite Setup
//===================
function Get_Battle_Sprite_Stats_Jason_SDMN(_animation,_stat){
	//=============
...
//===============================
function Get_Weapon_Position_Jason_SDMN(_object,_stat){
	...
	switch(_sprite){
	    ...
	    case spr_Jason_Attack:
	        switch(_frame){
	            case 1: _x_pos = 59; _y_pos = 69; _rotation = 135; break;
				default:  _x_pos = 74; _y_pos = 34; _rotation = 340; break;
	        }
	    break;
	    case spr_Jason_Block:
	        switch(_frame){
	            default: _x_pos = 77; _y_pos = 42; _rotation = 135; break;
	        }
	    break;
