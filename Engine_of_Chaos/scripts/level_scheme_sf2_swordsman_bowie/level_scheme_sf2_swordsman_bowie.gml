function Level_Scheme_SF2_Swordsman_Bowie(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
		case "Max_Health": _base = 12; _projected = 58; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Max_Magic": _base = 8; _projected = 16; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    case "Attack": _base = 6; _projected = 40; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 4; _projected = 36; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 4; _projected = 32; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    ...
	    case "Class_Name": _base = "Swordsman"; break;
	    case "Class_Abbreviation": _base = "SDMN"; break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Hero_Bowie"; break;
