...
//======================
function Town_Character_Stats_Max(){
...
function Get_Appearance_Max(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Max_Overworld; 
	var _portrait = spr_Max_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Max_ARCR";
	...
	switch(Get_Character_Class(_lookup_type,_character,"Abbreviation")){
		case "SNPR": _overworld_sprite = spr_Chicken_Overworld; break;
	}
	//=====================
...
//Battle Sprite Setup
//===================
function Get_Battle_Sprite_Stats_Max_ARCR(_animation,_stat){
	//=============
...
//===============================
function Get_Weapon_Position_Max_ARCR(_object,_stat){
