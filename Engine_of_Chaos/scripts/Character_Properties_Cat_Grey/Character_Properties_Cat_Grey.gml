function Town_Character_Stats_Cat_Grey(_character){
	with(_character){
...
//======================
function Get_Appearance_Cat_Grey(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Cat_Grey_Overworld;
	var _portrait = noone;
