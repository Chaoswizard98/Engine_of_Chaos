function Level_Scheme_Knight_1(_lookup_type,_character,_stat,_sub_stat){
	...
	//=================
	switch(_stat){
	    case "Attack": _base = 8; _early_gain = 1; _mid_gain = 1; _late_gain = 1; break;
	    case "Defense": _base = 4; _early_gain = 1; _mid_gain = 1; _late_gain = 1; break;
	    case "Agility": _base = 4; _early_gain = .9; _mid_gain = .9; _late_gain = .9; break;
	    case "Max_Health": _base = 11; _early_gain = 1.6; _mid_gain = 1.6; _late_gain = 1.6; break;
