function Town_Character_Stats_Ashenwood_Adventurer_2(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "Ashenwood_Adventurer_2";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_Ashenwood_Adventurer_2(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Ashenwood_Adventurer_2_Overworld;
	var _portrait = noone;
