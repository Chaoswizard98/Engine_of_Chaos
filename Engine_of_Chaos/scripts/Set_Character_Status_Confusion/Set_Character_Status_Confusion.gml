function Set_Character_Status_Confusion(_lookup_type,_character,_formula,_ammount,_stat) {
	var _base, _index;
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Confusion[_character,_index] = _base;
	}
	else if(_lookup_type = "Local"){
	    _character.confusion[_index] = _base;
	}
