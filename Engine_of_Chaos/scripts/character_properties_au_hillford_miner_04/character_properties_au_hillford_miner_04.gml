function Town_Character_Stats_AU_Hillford_Miner_04(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "AU_Hillford_Miner_04";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_AU_Hillford_Miner_04(_lookup_type,_character,_stat){
