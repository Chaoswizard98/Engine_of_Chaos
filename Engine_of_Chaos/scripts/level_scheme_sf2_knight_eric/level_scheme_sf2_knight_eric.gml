function Level_Scheme_SF2_Knight_Eric(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 10; _projected = 61; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Middle"); break;
	    case "Max_Magic": _base = 0; _projected = 0; _gain = 0; break;
	    case "Attack": _base = 7; _projected = 36; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    case "Defense": _base = 7; _projected = 34; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    case "Agility": _base = 6; _projected = 35; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Paladin_Eric"; break;
	    case "Promotion_2": _base = "SF2_Pegasus_Knight_Eric"; break;
