	...
	switch(_menu){
	    ...
	    case "Party_Management":
	        switch(_message_ID){
	            ...
	            case "Swap_Party_Members": return (_data1 +", why don't you take a rest now?%#"+_data2 +", fight bravely on the front!") break;
	        }
	    break;
	    //==============
	    //Shop Messages=
	    ...
	    case "Default_Shop":
	        switch(_message_ID){
	            case "Start_Buy_Deals": return ("You must be surprised!#What do you want to buy?@"); break;
	            case "Start_Buy": return ("What do you want to buy?@"); break;
	            case "Start_Sell": return ("Whose and which item do#you want to sell?"); break;
	            case "Start_Repair": return ("Whose and which item#shall I repair?"); break;
	            case "Not_Damaged": return ("It's not damaged."); break;
	            case "Out_Of_Stock": return "I'm very sorry!#I'm out of stock!"; break;
	            case "Who_Gets_It?": return ("#Who gets it?"); break;
	            case "Not_Enough_Gold": return ("#You need more money to buy it."); break;
	            case "Cancel_Purchase": return ("Oh...shucks!"); break;
	            case "Equip_Item?": return ("Equip it now?@"); break;
	            case "Buy_Item": return ("Here ya go!#Use it wisely!"); break;
	            case "Start_Empty_Faction": return ("You weren't expecting to use my services now were you?"); break;
            
	            case "Item_Costs_X": return ("#The "+_data1+" costs#"+_data2+ " gold coins.#OK?@"); break;
            
	            case "Cant_Equip": return (_data1 + " can't be equipped with it. OK?@"); break;
	            case "Hands_Full": return ("Oops! " + _data1 + "'s hands#are full! To anybody else?@"); break;
	            case "Cant_Equip_Cursed": return (_data1 + " can't remove#the cursed equipment.%#Here ya go!#Use it wisely!"); break;
	            case "Buy_And_Equip_Cursed": return ("Gosh!^ " + _data1 + " has been cursed!"); break;
	            case "Buy_And_Equip": return ("Ah, it suits you!"); break;
            
	            case "Buy_For_X": return ("I'll pay " + _data1+ " gold coins#for it, OK?@"); break;
	            case "Buy_For_X_Rare": return ("Wow, it's a rare bird!#I'll pay " + _data1+ " gold coins#for it, OK?@"); break;
	            case "Repair_For_X": return ("I'll repair that for " + _data1+ " gold coins.#OK?@"); break;
	            ...
	            case "Cancel_Sell_Cursed": return ("Hey, that's one of those cursed items isn't it?%#Sorry but I won't be buying that!"); break;
	        }
	    break;
	    //================
	    //Church Messages=
	    ...
	    case "Default_Church":
	        switch(_message_ID){
	            ...
	            case "Revive_For_X": return ("Gosh! " + _data1 + " is#exhausted!%#But I can recall the soul.%#It will cost "+_data2+ " gold#coins. OK?@"); break;
	            case "Cant_Afford": return ("You can't afford it!?#What a pity..."); break;
	            ...
	            case "Cure_Poison_For_X": return ("Gosh! " + _data1 + " is#poisoned!%#But I can treat it.%#It will cost "+_data2+ " gold#coins. OK?@"); break;
	            case "Cure_Paralyzed_For_X": return ("Gosh! " + _data1 + " is#paralyzed!%#But I can treat it.%#It will cost "+_data2+ " gold#coins. OK?@"); break;
	            case "Cure_Curse_For_X": return ("Gosh! " + _data1 + " is#cursed!%#But I can treat it.%#It will cost "+_data2+ " gold#coins. OK?@"); break;
	            ...
	            case "Promote": return ("Now, let me conduct the rite.#The light blesses... " +_data1+" "+_data2 + "...%#With the class of " +_data3+"!@"); break;
	    ...
	    case "Member_List":
	        switch(_message_ID){
	            ...
	            case "Cancel_Drop_Cursed": return ("You cannot drop the#"+_data1+".^#It's cursed!"); break;
	        }
	    break;
	    //================
	    //Spell Selection=
	    ...
	    case "Generic_Battle":
	        switch(_message_ID){
	            ...
	            case "Consumed_Spell_MP": return ("#" + _data1 + "'s active spells consumed " + _data2 + " MP.%"); break;
	            case "Break_Spell_Maintain": return ("#" + _data1 + "'s active spells can no longer be maintained.%"); break;
	        }
	    break;
	    //=================
	    //Battle Cutscenes=
	    ...
	    case "Battle_Cutscene":
	        switch(_message_ID){
	            ...
	            case "Was_Defeated": return ("#" + _data1 + " was defeated."); break;
	            ...
	            case "Found_Gold": return ("#Found " + _data1 + " gold."); break;
            
	            case "Item_Damaged": return ("#Cracks appear in the " + _data1 + "."); break;
	            case "Item_Broke": return ("#The " + _data1 + " turned to dust!"); break;
	            case "Item_Dropped": return ("#" + _data1 + " dropped the " + _data2 + "."); break;
	            case "Item_Recieved": return ("#" + _data1 + " recieved the " + _data2 + "."); break;
	            case "Inventory_Full": return ("#But " + _data1 + " cannot hold it!"); break;
	    ...
	    case "Level_Up":
	        switch(_message_ID){
	            ...
	            case "Gain_Attack": return ("#Attack increased by " + _data1 + "!"); break;
	            case "Gain_Defense": return ("#Defense increased by " + _data1 + "!"); break;
	            case "Gain_Agility": return ("#Agility increased by " + _data1 + "!"); break;
	            case "Gain_Max_Health": return ("#Maximum HP increased by " + _data1 + "!"); break;
	            case "Gain_Max_Magic": return ("#Maximum MP increased by " + _data1 + "!"); break;
	            case "Learn_Spell": return ("#Learned the new " + _data1 + " spell!"); break;
	            case "Increase_Spell_Level": return ("#" + _data1 + " is now level " + _data2 + "!"); break;
	        }
	    break;
	    //===========
	    //Containers=
	    ...
	    case "Containers":
	        switch(_message_ID){
	            ...
	            case "Found_Item": return (_data1 + " found the#" + _data2 + "."); break;
