function Spell_Stats_AU_Freeze(_effect_level,_lookup_type,_character){
	//================
	//Set Spell Stats=
	//================
	spell_name = Get_Spell_Display_Name("Freeze","Spell_Name","Freeze");//Get name from language script
	menu_name = Get_Spell_Display_Name("Freeze","Menu_Name","Freeze");//Get name from language script
	...
	switch(_effect_level){
	    case 1: ice_damage = 8; max_target_range = 2; area = 1; magic_cost = 2; break;
	    case 2: ice_damage = 10; max_target_range = 2; area = 2; magic_cost = 6; break;
	    case 3: ice_damage = 15; max_target_range = 2; area = 2; magic_cost = 10; break;
	    case 4: ice_damage = 40; max_target_range = 2; area = 1; magic_cost = 10; break;
	}
}
