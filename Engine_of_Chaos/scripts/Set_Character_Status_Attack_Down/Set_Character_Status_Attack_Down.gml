function Set_Character_Status_Attack_Down(_lookup_type,_character,_formula,_ammount,_stat) {
	var _base, _index;
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Attack_Down[_character,_index] = _base;
	}
	else if(_lookup_type = "Local"){
	    _character.attack_down[_index] = _base;
	}
