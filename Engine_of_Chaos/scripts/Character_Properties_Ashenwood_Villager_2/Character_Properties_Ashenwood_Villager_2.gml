function Town_Character_Stats_Ashenwood_Villager_2(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "Ashenwood_Villager_2";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_Ashenwood_Villager_2(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Ashenwood_Villager_2_Overworld;
	var _portrait = noone;
	var _voice = Get_Generic_Voice("Male_Young_1");
