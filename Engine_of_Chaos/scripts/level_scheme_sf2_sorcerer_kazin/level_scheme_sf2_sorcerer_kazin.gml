function Level_Scheme_SF2_Sorcerer_Kazin(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 26; _projected = 77; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    case "Max_Magic": _base = 40; _projected = 90; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Attack": _base = 13; _projected = 28; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 18; _projected = 60; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 29; _projected = 60; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early+Late"); break;
	    ...
	    case "Class_Name": _base = "Sorcerer"; break;
	    case "Class_Abbreviation": _base = "SORC"; break;
	    case "Movement_Range": _base = 5; break;
	    case "Movement_Type": _base = "Foot"; break;
	    case "Reset_Spells": _base = true; break;
	    
		case "Spell_1": 
			_base = "SF2_Dao"; 
			_level = 1; 
			switch(Get_Character_Level(_lookup_type,_character,"Total")){
				case 32: _level = 2; break;
			}
		break;
	    ...
	    case "Spell_2": 
			_base = "SF2_Apollo";
		switch(Get_Character_Level(_lookup_type,_character,"Total")){
				case 24: _level = 1; break;
				case 37: _level = 2; break;
			}
		break;
	    ...
	    case "Spell_3": 
			_base = "SF2_Neptune"; 
		switch(Get_Character_Level(_lookup_type,_character,"Total")){
				case 27: _level = 1; break;
				case 46: _level = 2; break;
			}
		break;
	    ...
	    case "Meets_Requirements": _base = ((_character_level >= 20) && Has_Item_In_Inventory(_lookup_type,_character,"SF2_Secret_Book")) break;
	    case "Promotion_Event": Remove_Item(_lookup_type,_character,Get_Item_Slot(_lookup_type,_character,"SF2_Secret_Book")); break;//Put whatever script you want in here. (Such as removing an item upon promotion)
	}
