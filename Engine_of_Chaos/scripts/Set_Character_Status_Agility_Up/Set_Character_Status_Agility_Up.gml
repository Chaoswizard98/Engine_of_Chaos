function Set_Character_Status_Agility_Up(_lookup_type,_character,_formula,_ammount,_stat) {
	var _base, _index;
	...
	if(_lookup_type = "Global"){
	    _base = global.Agility_Up[_character,_index];
	}
	else if(_lookup_type = "Local"){
	    _base = _character.agility_up[_index];
	}
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Agility_Up[_character,_index] = _base;
	}
	else if(_lookup_type = "Local"){
	    _character.agility_up[_index] = _base;
	}
