function Level_Scheme_SF2_Golem_Claude(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	switch(_stat){
	    ...
	    case "Attack": _base = 49; _projected = 110; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 35; _projected = 112; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 22; _projected = 50; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    ...
	    case "Class_Name": _base = "Golem"; break;
	    case "Class_Abbreviation": _base = "GLM"; break;
	    case "Movement_Range": _base = 4; break;
