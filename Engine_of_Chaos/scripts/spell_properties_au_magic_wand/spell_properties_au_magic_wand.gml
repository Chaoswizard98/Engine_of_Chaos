function Spell_Stats_AU_Magic_Wand(_effect_level,_lookup_type,_character){
	//================
	//Set Spell Stats=
	//================
	spell_name = Get_Spell_Display_Name("AU_Magic_Wand","Spell_Name","Magic Wand");//Get name from language script
	menu_name = Get_Spell_Display_Name("AU_Magic_Wand","Menu_Name","Magic Wand");//Get name from language script
	...
	switch(_effect_level){
	    case 1: fire_damage = 4; max_target_range = 2; area = 1; magic_cost = 2; break;
...
//=====================
function Spell_Animation_Create_Event_AU_Magic_Wand(_object){
...
//====================
function Spell_Animation_Loop_Event_AU_Magic_Wand(_object){
