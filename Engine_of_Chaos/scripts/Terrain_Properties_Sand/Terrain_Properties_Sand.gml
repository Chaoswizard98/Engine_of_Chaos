function Get_Terrain_Stats_Sand(_movement_type,_stat){
	//=============
	//Default Stats
	//=============
	var _sprite = spr_Terrain_Sand;
	var _background_sprite = spr_Battle_Background_Sand;
	var _foreground_sprite = spr_Battle_Foreground_Sand;
	...
	switch(_movement_type){
	    ...
	    case "Fast": _movement_cost = 2; _land_effect = .30; break;
