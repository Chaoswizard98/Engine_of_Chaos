function Town_Character_Stats_AU_Hillford_Door_Blocker_01(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "AU_Hillford_Door_Blocker_01";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_AU_Hillford_Door_Blocker_01(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_AU_Hillford_Adventurer_01_Overworld;
	var _portrait = noone;
