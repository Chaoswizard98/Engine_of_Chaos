function Buy_Item(_auto_equip) {
	...
	if(obj_Shop_Controller.shop_type = "Quantity"){
	    var i = 0;
	    for(i = obj_Shop_Controller.item_index; i<global.Quantity_Shop_Size[obj_Shop_Controller.quantity_shop_index] -1; i+= 1){//loop through inventory and shift items down 1 slot
	    ...
	    global.Quantity_Shop_Size[obj_Shop_Controller.quantity_shop_index] -= 1;
	    obj_Shop_Controller.item_array[global.Quantity_Shop_Size[obj_Shop_Controller.quantity_shop_index]] = "none";
