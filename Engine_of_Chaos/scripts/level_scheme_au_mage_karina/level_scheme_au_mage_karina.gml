function Level_Scheme_AU_Mage_Karina(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	switch(_stat){
		...
		switch(Get_Character_Level(_lookup_type,_character,"Total")){
				...
				case 18: _level = 2; break;
				case 40: _level = 3; break;
				case 50: _level = 4; break;
			}
		break;
