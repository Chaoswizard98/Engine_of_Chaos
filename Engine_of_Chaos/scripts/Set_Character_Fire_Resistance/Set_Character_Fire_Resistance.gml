function Set_Character_Fire_Resistance(_lookup_type,_character,_formula,_ammount) {
	var _base;
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Fire_Resistance[_character] = max(_base,1);
	}
	else if(_lookup_type = "Local"){
	    _character.fire_resistance = max(_base,1);
	}
