function Get_Terrain_Stats_Plains(_movement_type,_stat){
	//=============
	//Default Stats
	//=============
	var _sprite = spr_Terrain_Plains;
	var _background_sprite = spr_Battle_Background_Plains;
	var _foreground_sprite = spr_Battle_Foreground_Plains;
	...
	switch(_movement_type){
	    ...
	    case "Foot": _movement_cost = 1; _land_effect = .15; break;
	    case "Horse": _movement_cost = 1; _land_effect = .15; break;
	    case "Fast": _movement_cost = 1; _land_effect = .15; break;
	    case "Tires": _movement_cost = 1; _land_effect = .15; break;
	    case "Flying": _movement_cost = 1; _land_effect = 0; break;
	    case "Hover": _movement_cost = 1; _land_effect = .15; break;
	    case "Aquatic": _movement_cost = 0; _land_effect = 0; break;
	    case "Amphibious": _movement_cost = 1; _land_effect = .15; break;
	}
