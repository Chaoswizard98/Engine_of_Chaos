function Generic_Priest_Dialogue(){
	var _player, _npc;
	...
	switch(state){
	    case 0:
			Create_Character_Dialogue("Local",_npc,Get_NPC_Dialogue_Messages(_npc,_player,"Default_Priest_Greeting"),id,true,true);
	        state += 1;
	    break;
	    case 1:
	        state += 1;
	        Create_Church_Menu(id,_player,_npc);//current object, current character
	    break;
	    case 2:
			Create_Character_Dialogue("Local",_npc,Get_NPC_Dialogue_Messages(_npc,_player,"Default_Priest_Farewell"),id,true,true);
	        state += 1;
	    break;
	    case 3:
	        state += 1;
