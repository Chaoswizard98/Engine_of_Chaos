function Level_Scheme_SF2_Paladin_Eric(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	switch(_stat){
	    ...
	    case "Defense": _base = 23; _projected = 79; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
	    case "Agility": _base = 23; _projected = 73; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
