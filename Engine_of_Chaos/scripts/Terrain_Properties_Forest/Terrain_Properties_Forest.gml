function Get_Terrain_Stats_Forest(_movement_type,_stat){
	//=============
	//Default Stats
	//=============
	var _sprite = spr_Terrain_Forest;
	var _background_sprite = spr_Battle_Background_Forest;
	...
	switch(_movement_type){
	    ...
	    case "Foot": _movement_cost = 2; _land_effect = .30; break;
	    case "Horse": _movement_cost = 2.5; _land_effect = .30; break;
	    case "Fast": _movement_cost = 1; _land_effect = .30; break;
	    case "Tires": _movement_cost = 1.5; _land_effect = .30; break;
	    ...
	    case "Amphibious": _movement_cost = 2; _land_effect = .30; break;
	}
