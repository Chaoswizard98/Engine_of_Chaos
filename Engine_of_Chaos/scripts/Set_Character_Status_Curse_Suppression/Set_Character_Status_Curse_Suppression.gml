function Set_Character_Status_Curse_Suppression(_lookup_type,_character,_formula,_ammount,_stat) {
	var _base, _index;
	...
	//Apply new stats
	if(_lookup_type = "Global"){
	    global.Curse_Suppression[_character,_index] = _base;
	}
	else if(_lookup_type = "Local"){
	    _character.curse_suppression[_index] = _base;
	}
