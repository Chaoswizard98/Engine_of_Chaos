function Get_Terrain_Stats_Hills(_movement_type,_stat){
	//=============
	//Default Stats
	//=============
	var _sprite = spr_Terrain_Hills;
	var _background_sprite = spr_Battle_Background_Hills;
	var _foreground_sprite = spr_Battle_Foreground_Hills;
