function Battle_Prop_Stats_SF2_Blaze_Dragon_Body_2(_stat){
	var _sprite = spr_SF2_Blaze_Dragon_3;
...
function Battle_Prop_Loop_Event_SF2_Blaze_Dragon_Body_2(_prop){
	with(_prop){
		var _previous = x;
