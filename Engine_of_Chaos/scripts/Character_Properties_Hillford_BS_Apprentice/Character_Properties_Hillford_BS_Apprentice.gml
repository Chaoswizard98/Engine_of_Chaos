function Town_Character_Stats_Hillford_BS_Apprentice(_character){
	with(_character){
		is_npc = true;//Flag them as an NPC
		dialogue_ID = "Hillford_BS_Apprentice";//Dialogue Message ID to print when talked to
...
//======================
function Get_Appearance_Hillford_BS_Apprentice(_lookup_type,_character,_stat){
