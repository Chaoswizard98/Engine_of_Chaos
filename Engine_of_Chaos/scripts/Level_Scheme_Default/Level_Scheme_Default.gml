function Level_Scheme_Default(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	var _max_level = 1;//Max level for this class.
	var _max_growth_level = 1;//Max growth level for this class. (after this level, any future growths are averaged)
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 1; _projected = 1; _gain = 0; break;
	    case "Max_Magic": _base = 0; _projected = 0; _gain = 0; break;
	    case "Attack": _base = 1; _projected = 1; _gain = 0; break;
	    case "Defense": _base = 1; _projected = 1; _gain = 0; break;
	    case "Agility": _base = 1; _projected = 1; _gain = 0; break;
	    ...
	    case "Meets_Requirements": _base = false; break;
