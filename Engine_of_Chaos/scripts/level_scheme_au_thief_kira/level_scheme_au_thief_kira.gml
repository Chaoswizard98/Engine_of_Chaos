function Level_Scheme_AU_Thief_Kira(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	switch(_stat){
	    ...
	    case "Attack": _base = 6; _projected = 45; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Late"); break;
