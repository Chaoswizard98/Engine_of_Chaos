function Level_Scheme_SF2_Archer_Janet(_lookup_type,_character,_stat,_sub_stat,_character_level){
	...
	//=================
	switch(_stat){
	    case "Max_Health": _base = 10; _projected = 42; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Max_Magic": _base = 0; _projected = 0; _gain = 0; break;
	    case "Attack": _base = 6; _projected = 28; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Defense": _base = 4; _projected = 30; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Linear"); break;
	    case "Agility": _base = 6; _projected = 32; _gain = Get_Stat_Curve_Basic(_base_level,_max_growth_level,_class_level,_base,_projected,"Early"); break;
	    ...
	    case "Class_Name": _base = "Archer"; break;
	    case "Class_Abbreviation": _base = "ARCR"; break;
	    ...
	    //Promotion options
	    case "Promotion_1": _base = "SF2_Sniper_Janet"; break;
	    case "Promotion_2": _base = "SF2_Brass_Gunner_Janet"; break;
